...
class EngineArgs:
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        scheduler_group.add_argument(
            ...
            **{
                **scheduler_kwargs["max_num_mixed_prefill_tokens"],
                "default": None,
            },
        )
    ...
    def create_engine_config(
        ...
        if max_num_mixed_prefill_tokens is None:
            # Cubic kernels cover a wide range of weight/activation bit-widths
            # and model architectures. Prefer bounded mixed-step latency for
            # all of them without changing the default scheduler policy for
            # unrelated quantization methods.
            max_num_mixed_prefill_tokens = (
                -1 if str(model_config.quantization).lower() == "cubic" else 0
            )
