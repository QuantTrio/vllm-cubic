...
class CUDAGraphWrapper:
    ...
    def __call__(self, *args: Any, **kwargs: Any) -> Any | None:
        ...
        # A PIECEWISE graph was captured before any ubatch context existed and
        # is therefore bound to its original compute stream.  Replaying it
        # while an outer DBO FULL graph is being captured would hide all
        # distributed-op scheduling points and serialize both microbatches.
        # Run the underlying partition so the outer graph can capture the
        # ubatch compute/communication streams and their event dependencies.
