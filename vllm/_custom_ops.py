...
def concat_and_cache_mla(
    ...
    # fp8_q16 changes the attention-side query contract, not the physical KV
    # representation.  The generic cache writer only needs the underlying
    # E4M3 format name understood by its C++ dtype parser.
