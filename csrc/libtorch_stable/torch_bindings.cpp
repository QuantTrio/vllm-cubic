...
STABLE_TORCH_LIBRARY_FRAGMENT(_C, ops) {
  ...
  ops.def(
      "fused_kimi_k3_mla_key_concat_kv_cache_fp8_q16_insert("
      "Tensor! q, Tensor k_nope, Tensor k_pe, Tensor kv_c_normed, "
      "Tensor! k_out, Tensor! k_cache, Tensor slot_mapping, "
      "Tensor cache_scale_inv, int cache_block_size, "
...
STABLE_TORCH_LIBRARY_IMPL(_C, CUDA, ops) {
  ...
  ops.impl("fused_kimi_k3_mla_key_concat_kv_cache_fp8_q16_insert",
           TORCH_BOX(&fused_kimi_k3_mla_key_concat_kv_cache_fp8_q16_insert));
  ...
  ops.impl(
      "fused_kimi_k3_mla_decode_q_concat_kv_cache_fp8_q16_insert",
      TORCH_BOX(&fused_kimi_k3_mla_decode_q_concat_kv_cache_fp8_q16_insert));
