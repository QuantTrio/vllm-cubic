...
# Add the query-protected BF16-Q / compressed INT8 and Cubic8 MLA SM90 decode
# paths to the pinned FlashMLA source. Keep this as an explicit, reviewable
# patch instead of carrying an opaque modified dependency checkout.
...
if(NOT FLASHMLA_COMPRESSED_MLA_ALREADY_APPLIED EQUAL 0)
  ...
  if(NOT FLASHMLA_COMPRESSED_MLA_PATCH_CHECK EQUAL 0)
    message(FATAL_ERROR
      "Cannot apply FlashMLA compressed MLA A16 patch: "
